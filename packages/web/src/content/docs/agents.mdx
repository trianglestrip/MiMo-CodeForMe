...
A full-capability general-purpose subagent for autonomous investigation, implementation, debugging, testing, and other multi-step work. It inherits the parent's available, model-appropriate tool surface and can read, write, execute commands, and complete a delegated task end to end.
