...
export const dict = {
  ...
  "tui.skill.playwright.description": "透過終端自動化真實瀏覽器操作",
  ...
  "tui.skill.grok-build.description": "透過命令列操作 Grok Build",
  ...
  "tui.command.context_limit.title": "設定上下文上限（提前壓縮）",
  "tui.context_limit.title": "上下文上限 — {{model}}",
  "tui.context_limit.hint": "模型視窗 {{window}}，{{compact}} 時壓縮",
  "tui.context_limit.option.default": "模型預設（{{value}}）",
  "tui.context_limit.option.default_description": "依模型自身視窗壓縮",
  "tui.context_limit.option.tier_description": "約 {{value}} 時壓縮",
  "tui.context_limit.option.custom": "自訂…",
  "tui.context_limit.option.custom_description": '輸入 token 數、"300K" 或 "50%"',
  "tui.context_limit.custom_title": "上下文上限",
  "tui.context_limit.custom_description": 'token 數、"300K"、"1M" 或 "50%"，必須小於 {{window}}',
  "tui.context_limit.saved": "{{model}} 將在 {{value}} 時壓縮",
  "tui.context_limit.cleared": "{{model}} 已恢復為模型視窗",
  "tui.context_limit.invalid": "不是有效的 token 數量：{{value}}",
  "tui.context_limit.too_large": "必須小於模型視窗（{{window}}）",
  ...
  "tui.command.skip_permissions.toast_on":
    "已開啟跳過權限確認 — 權限請求自動放行（含子代理）。破壞性命令仍會詢問確認。",
  "tui.command.skip_permissions.toast_off": "已關閉跳過權限確認 — 權限請求將重新需要你確認。",
  "tui.command.permission_timeout.title": "設定權限詢問超時",
  "tui.permission_timeout.title": "權限詢問超時",
  "tui.permission_timeout.hint": "等待人工確認的超時時間，超時後自動拒絕。",
  "tui.permission_timeout.option.never": "永不超時",
  "tui.permission_timeout.option.never_description": "無限等待人工確認",
  "tui.permission_timeout.option.tier_description": "{{duration}}後自動拒絕",
  "tui.permission_timeout.toast_never": "已關閉權限超時 — 詢問將無限等待。",
  "tui.permission_timeout.toast_set": "權限超時已設為 {{duration}}。",
