...
export const dict = {
  ...
  "tui.skill.playwright.description": "通过终端自动化真实浏览器操作",
  ...
  "tui.skill.grok-build.description": "通过命令行操作 Grok Build",
  ...
  "tui.skill.compose-next.description":
    "新一代编排模式：面向强模型的端到端特性开发（明确需求、写 spec、实现、验证、评审、收尾）",
  ...
  "tui.skill.playwright.slash": "浏览器自动化",
  "tui.skill.codex.slash": "Codex编程",
  "tui.skill.claude-code.slash": "Claude编程",
  "tui.skill.grok-build.slash": "Grok构建",
  ...
  "tui.skill.compose-next.slash": "新编排模式",
  ...
  "tui.command.context_limit.title": "设置上下文上限（提前压缩）",
  "tui.context_limit.title": "上下文上限 — {{model}}",
  "tui.context_limit.hint": "模型窗口 {{window}}，{{compact}} 时压缩",
  "tui.context_limit.option.default": "模型默认（{{value}}）",
  "tui.context_limit.option.default_description": "按模型自身窗口压缩",
  "tui.context_limit.option.tier_description": "约 {{value}} 时压缩",
  "tui.context_limit.option.custom": "自定义…",
  "tui.context_limit.option.custom_description": '输入 token 数、"300K" 或 "50%"',
  "tui.context_limit.custom_title": "上下文上限",
  "tui.context_limit.custom_description": 'token 数、"300K"、"1M" 或 "50%"，必须小于 {{window}}',
  "tui.context_limit.saved": "{{model}} 将在 {{value}} 时压缩",
  "tui.context_limit.cleared": "{{model}} 已恢复为模型窗口",
  "tui.context_limit.invalid": "不是有效的 token 数量：{{value}}",
  "tui.context_limit.too_large": "必须小于模型窗口（{{window}}）",
  "tui.context_limit.busy": "会话运行中，无法修改上下文上限",
  "tui.context_limit.too_small": "必须为 {{reserved}} 的压缩预留留出空间",
  "tui.context_limit.scalar_config": "compaction.max_context 当前是对所有模型生效的单值，请在 mimocode.json 中改为按模型配置",
  "tui.context_limit.shadowed": "已保存，但仍有其他配置将其固定为 {{value}}，请检查项目的 mimocode.json",
  "tui.context_limit.no_model": "未选择模型",
  ...
  "tui.command.skip_permissions.toast_on":
    "已开启跳过权限确认 — 权限请求自动放行（含子代理）。破坏性命令仍会询问确认。",
  ...
  "tui.permission_timeout.toast_never": "已关闭权限超时 — 询问将无限等待。",
  "tui.permission_timeout.toast_set": "权限超时已设为 {{duration}}。",
  ...
  "tui.dialog.try_best.reason.bash_retry": "同一条失败命令在没有成功编辑的情况下重试了 {{count}} 次。",
  "tui.dialog.try_best.reason.action_streak": "连续 {{count}} 次{{action}}操作没有产生可观察的进展。",
  "tui.dialog.try_best.action.edit": "编辑",
  "tui.dialog.try_best.action.verify": "验证",
  "tui.dialog.try_best.action.same_kind": "同类",
  "tui.dialog.try_best.handoff.title": "交接给 {{target}}",
  "tui.dialog.try_best.handoff.description": "让 MiMo 将未完成的工作委派给此 harness",
  "tui.dialog.try_best.continue.title": "使用 {{model}} 继续",
